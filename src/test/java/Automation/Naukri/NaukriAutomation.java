...
//	            emailField.sendKeys(System.getenv("NAUKRI_EMAIL")); // Email from environment variable
//	            passwordField.sendKeys(System.getenv("NAUKRI_PASSWORD")); // Password from environment variable
			...
			Thread.sleep(2000);
			WebElement logout = wait.until(ExpectedConditions.elementToBeClickable(driver.findElement(By.linkText("Logout"))));
			logout.click();
